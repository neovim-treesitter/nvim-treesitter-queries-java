...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-java/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-java/actions/workflows/validate.yml)

Neovim tree-sitter queries for **java**, part of the
...
- [ ] Changes are scoped to `java` — do not include files for other languages
